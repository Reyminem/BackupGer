...
"C:\Program Files\7-Zip\7z.exe" a -tzip "C:\BKP_1.2\Backup\Domingo\Domingo.zip" "*.bak"
copy "C:\BKP_1.2\Backup\Domingo\Domingo.zip" "C:\Program Files (x86)\12informatica\BackupDrive\Domingo"
