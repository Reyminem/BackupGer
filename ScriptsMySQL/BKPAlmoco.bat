...
"C:\Program Files\7-Zip\7z.exe" a -tzip "C:\BKP_1.2\Backup\Almoco\AlmocoMySQL.zip" "*.sql"
copy "C:\BKP_1.2\Backup\Almoco\AlmocoMySQL.zip" "C:\Program Files (x86)\12informatica\BackupDrive\Almoco"
